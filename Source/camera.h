...
class Camera {
 ...
 public:
  Eigen::Vector3f get_camera_position() { return camera_position_; }
  Eigen::Vector3f get_camera_target() { return camera_target_; }
  Eigen::Vector3f get_camera_direction() { return camera_direction_; }
  Eigen::Vector3f get_up_direction() { return up_direction_; }
  Eigen::Vector3f get_camera_right_direction() {
